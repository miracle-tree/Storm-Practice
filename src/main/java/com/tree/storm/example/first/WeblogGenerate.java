...
public class WeblogGenerate {
    ...
    public static void main(String[] args) {
        ...
        // 1 网站名称
        String[] hosts = { "www.atguigu.com","www.baidu.com","www.bilibili.com","www.github.com" };
        // 2 会话id
        ...
        for (int i = 0; i < 30; i++) {
            sbBuffer.append(hosts[random.nextInt(4)] + "\t" + session_id[random.nextInt(5)] + "\t" + time[random.nextInt(8)] + "\n");
            }
